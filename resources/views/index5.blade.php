        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div id="white" class="panel-heading">
                    <h3 class="panel-title" >#618</h3>
                    <h3 class="panel-title" >Mizuno Moreolla Azure Blue</h3>
                    <img src="{{asset("img/Mizuno/MizunoAzureBlue.jpeg")}}" width="140px" height="140px">
                    <span>$270</span>
                </div>
{{--                <ul class="list-group">--}}
...
{{--                </ul>--}}
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div id="white" class="panel-heading">
                    <h3 class="panel-title" >#619</h3>
                    <h3 class="panel-title" >Mizuno Moreolla SR4 Black</h3>
                    <img src="{{asset("img/Mizuno/MizunoSR4Black.webp")}}" width="140px" height="140px">
                    <span>$270</span>
                </div>
{{--                <ul class="list-group">--}}
{{--                    <li class="list-group-item"><a href="#">Watch Now<a/></li>--}}
{{--                </ul>--}}
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div id="white" class="panel-heading">
                    <h3 class="panel-title" >#620</h3>
                    <h3 class="panel-title" >Mizuno Moreolla SR4 White</h3>
                    <img src="{{asset("img/Mizuno/MizunoSR4White.jpeg")}}" width="140px" height="140px">
                    <span>$270</span>
                </div>
{{--                <ul class="list-group">--}}
{{--                    <li class="list-group-item"><a href="#">Watch Now<a/></li>--}}
{{--                </ul>--}}
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div id="white" class="panel-heading">
                    <h3 class="panel-title" >#621</h3>
                    <h3 class="panel-title" >Mizuno Moreolla White</h3>
                    <img src="{{asset("img/Mizuno/MizunoWhite.jpeg")}}" width="140px" height="140px">
                    <span>$270</span>
                </div>
{{--                <ul class="list-group">--}}
{{--                    <li class="list-group-item"><a href="#">Watch Now<a/></li>--}}
