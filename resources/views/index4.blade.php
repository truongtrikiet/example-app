        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div id="white" class="panel-heading">
                    <h3 class="panel-title" >#615</h3>
                    <h3 class="panel-title" >Puma Future Z Neymar</h3>
                    <img src="{{asset("img/Puma/PumaFutureNJ.jpeg")}}" width="140px" height="140px">
                    <span>$270</span>
                </div>
{{--                <ul class="list-group">--}}
...
{{--                </ul>--}}
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div id="white" class="panel-heading">
                    <h3 class="panel-title" >#616</h3>
                    <h3 class="panel-title" >Puma Future Z Orange</h3>
                    <img src="{{asset("img/Puma/PumaFutureOrange.webp")}}" width="140px" height="140px">
                    <span>$270</span>
                </div>
{{--                <ul class="list-group">--}}
{{--                    <li class="list-group-item"><a href="#">Watch Now<a/></li>--}}
{{--                </ul>--}}
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div id="white" class="panel-heading">
                    <h3 class="panel-title" >#617</h3>
                    <h3 class="panel-title" >Puma Future Z Purple</h3>
                    <img src="{{asset("img/Puma/PumaFuturePurple.jpeg")}}" width="140px" height="140px">
                    <span>$270</span>
                </div>
{{--                <ul class="list-group">--}}
{{--                    <li class="list-group-item"><a href="#">Watch Now<a/></li>--}}
