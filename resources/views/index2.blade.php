        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div id="white" class="panel-heading">
                    <h3 class="panel-title" >#601</h3>
                    <h3 class="panel-title" >Nike Phantom</h3>
                       <img src="{{asset("img/nike-mercurial/Vapor14EuroPack.png")}}" width="140px" height="140px">
                    <span>150$</span>
                </div>
{{--                <ul class="list-group">--}}
...
{{--                </ul>--}}
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div id="white" class="panel-heading">
                    <h3 class="panel-title" >#602</h3>
                    <h3 class="panel-title" >Nike Vapor</h3>
                    <img src="{{asset("img/nike-mercurial/Vapor14BlackGolden.png")}}" width="140px" height="140px">
                    <span>250$</span>
                </div>
{{--                <ul class="list-group">--}}
{{--                    <li class="list-group-item"><a href="#">Watch Now<a/></li>--}}
{{--                </ul>--}}
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div id="white" class="panel-heading">
                    <h3 class="panel-title" >#603</h3>
                    <h3 class="panel-title" >Nike Tiempo</h3>
                    <img src="{{asset("img/nike-mercurial/Vapor14Green.png")}}" width="140px" height="140px">
                    <span>170$</span>
                </div>
{{--                <ul class="list-group">--}}
{{--                    <li class="list-group-item"><a href="#">Watch Now<a/></li>--}}
{{--                </ul>--}}
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div id="white" class="panel-heading">
                    <h3 class="panel-title" >#604</h3>
                    <h3 class="panel-title" >Nike CR7 Black</h3>
                    <img src="{{asset("img/nike-mercurial/Vapor14Javis.png")}}" width="140px" height="140px">
                    <span>125$</span>
                </div>
{{--                <ul class="list-group">--}}
{{--                    <li class="list-group-item"><a href="#">Watch Now<a/></li>--}}
...
{{--                    <h3 class="panel-title" >Nike Vapor 14 Safari</h3>--}}
{{--                    <img src="{{asset("img/nike-mercurial/Vapor14Safari.png")}}" width="140px" height="140px">--}}
{{--                    <span>$270</span>--}}
{{--                </div>--}}
{{--                <ul class="list-group">--}}
{{--                    <li class="list-group-item"><a href="#">Watch Now<a/></li>--}}
...
{{--                    <h3 class="panel-title" >Nike Vapor 14 Pink</h3>--}}
{{--                    <img src="{{asset("img/nike-mercurial/Vapor14Pink.png")}}" width="140px" height="140px">--}}
{{--                    <span>$270</span>--}}
{{--                </div>--}}
{{--                <ul class="list-group">--}}
{{--                    <li class="list-group-item"><a href="#">Watch Now<a/></li>--}}
...
{{--                    <h3 class="panel-title" >Nike Mercurial Vapor 14</h3>--}}
{{--                    <img src="{{asset("img/nike-mercurial/Vapor14GreyWhite.png")}}" width="140px" height="140px">--}}
{{--                    <span>$270</span>--}}
{{--                </div>--}}
{{--                <ul class="list-group">--}}
{{--                    <li class="list-group-item"><a href="#">Watch Now<a/></li>--}}
...
{{--                    <h3 class="panel-title" >Nike Mercurial Vapor 14</h3>--}}
{{--                    <img src="{{asset("img/nike-mercurial/Vapor14Olympic.png")}}" width="140px" height="140px">--}}
{{--                    <span>$270</span>--}}
{{--                </div>--}}
{{--                <ul class="list-group">--}}
{{--                    <li class="list-group-item"><a href="#">Watch Now<a/></li>--}}
